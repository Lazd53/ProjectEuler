...
const problemNum = 12;
const thePrompt = "The sequence of triangle numbers is generated by adding the natural numbers. \
        So the 7th triangle number would be 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. The first ten terms would be: 1, 3, 6, 10, 15, 21, 28, 36, 45, 55, ... <br>\
...
for (i=2; i<10; i++) {
  triangleArray.push(triangleArray[triangleArray.length-1]+i);
}
